...
{
    /// <inheritdoc />
    public partial class InitialStorefrontSchema : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HeroTitle = table.Column<string>(type: "character varying(160)", maxLength: 160, nullable: true),
                    ...
                    TextColor = table.Column<string>(type: "character varying(16)", maxLength: 16, nullable: false),
                    IsActive = table.Column<bool>(type: "boolean", nullable: false),
                    UpdatedAt = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_brand_sites", x => x.BrandId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_menu_categories", x => x.CategoryId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ExternalTransactionId = table.Column<string>(type: "character varying(80)", maxLength: 80, nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_brand_sites_IsActive",
                schema: "storefront",
                table: "brand_sites",
                column: "IsActive");

            migrationBuilder.CreateIndex(
                name: "IX_cart_items_CartId_MenuItemId",
                schema: "storefront",
                table: "cart_items",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_menu_categories_BrandId_IsActive",
                schema: "storefront",
                table: "menu_categories",
                columns: new[] { "BrandId", "IsActive" });

            migrationBuilder.CreateIndex(
                name: "IX_menu_items_BrandId_IsActive",
                schema: "storefront",
                table: "menu_items",
                columns: new[] { "BrandId", "IsActive" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_payment_transactions_BrandId",
                schema: "storefront",
                table: "payment_transactions",
                column: "BrandId");

            migrationBuilder.CreateIndex(
                name: "IX_payment_transactions_CartId",
                schema: "storefront",
                table: "payment_transactions",
                column: "CartId");
